...
const FeaturedDestination = () => {
  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20">
      ...
      <button onClick={()=> {navigate('/rooms'); scrollTo(0,0)}} className="my-16 px-4 py-2 text-sm fot-medium border border-gray-300 rounded bg-white hover:bg-gray-300 transition-all cursor-pointer">
